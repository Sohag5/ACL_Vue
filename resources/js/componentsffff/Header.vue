<template>
    <nav class="navbar navbar-expand-md navbar-dark navbar-laravel" style="background: red;">
        <div class="container">
                    ...
                    <template v-else>
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false" aria-haspopup="true">
                                <i class="fa fa-user"></i> {{ currentUser.first_name }} {{ currentUser.last_name }} <span class="caret"></span>
                            </a>
